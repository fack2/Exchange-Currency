...
const cal = ((req, res) => {
    ...
    request(`http://www.apilayer.net/api/live?access_key=${process.env.API_KEY}`, { json: true }, (err, res2, body) => {
        ...
        const result=currency.Amount*currency.USD2Currency2/currency.USD2Currency1
        // change(currency)
    ...
    // c11=body.quotes["USD"+c1];
    // c22=body.quotes["USD"+c2];
...
module.exports = {notFound,homePage,publicHandler,cal};
